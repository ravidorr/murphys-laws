...
- Android screens now consume `DS.Color.*` for vote thumbs and the markdown link colour: vote-up `Color(0xFF10b981)` -> `DS.Color.success`, vote-down `Color(0xFFef4444)` -> `DS.Color.error` across [SearchScreen.kt](android/app/src/main/java/com/murphyslaws/presentation/search/SearchScreen.kt), [LawDetailScreen.kt](android/app/src/main/java/com/murphyslaws/presentation/lawdetail/LawDetailScreen.kt), [HomeScreen.kt](android/app/src/main/java/com/murphyslaws/presentation/home/HomeScreen.kt), [LawListCard.kt](android/app/src/main/java/com/murphyslaws/presentation/components/LawListCard.kt); markdown links `Color(0xFF1976D2)` -> `DS.Color.btnPrimaryBg` in [MarkdownParser.kt](android/app/src/main/java/com/murphyslaws/util/MarkdownParser.kt); RiskLevel LOW/HIGH `Color.Green` / `Color.Red` -> `DS.Color.success` / `DS.Color.error` in [RiskLevel.kt](android/app/src/main/java/com/murphyslaws/domain/model/RiskLevel.kt). RiskLevel MEDIUM stays as `Color(0xFFFFA500)` with a comment because no DS token matches the bright friendly orange affordance (DESIGN.md's `orange-text` is the dark-brown calculator-pair foreground, not a chip indicator). Third-party brand colours for the social-share icons (X, Facebook, LinkedIn, Reddit, Email) intentionally stay inline; they aren't part of the Murphy's Laws design system. PR Android-2 of the design-tokens-mobile rollout. Android app bumped to `1.0.2` / versionCode `3`; root to `2.4.22`.
