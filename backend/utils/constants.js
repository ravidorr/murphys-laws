...
export const API_VERSION_PREFIX = '/api/v1'; // API version prefix for mobile app support
export const API_SHARE_CALCULATION_ENDPOINT = `${API_VERSION_PREFIX}/share-calculation`;
