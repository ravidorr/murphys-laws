...
export class FeedController {
   ...
   */
  _sendXml(res: any, xml: string, contentType: string) {
    res.writeHead(200, {
   ...
   */
  _sendError(res: any, statusCode: number, message: string) {
   ...
   * @param {object} res - HTTP response object
   */
  async getRssFeed(req: any, res: any) {
    try {
   ...
   * @param {object} res - HTTP response object
   */
  async getAtomFeed(req: any, res: any) {
    try {
