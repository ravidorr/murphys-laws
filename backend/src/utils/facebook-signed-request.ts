...
export function parseSignedRequest(
  ...
  try {
    // Decode the payload
    const payload = JSON.parse(base64UrlDecode(encodedPayload)) as SignedRequestPayload;
 ...
 */
export function generateConfirmationCode(facebookUserId: string | number): string {
