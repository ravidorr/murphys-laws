 ...
 */
export function createLawSubmissionEmailSubject(lawId) {
 ...
 */
export function createLawSubmissionEmailText(lawData, reviewUrl = 'http://murphys-laws.com/admin') {
 ...
 */
export function createLawSubmissionEmailHtml(lawData, reviewUrl = 'http://murphys-laws.com/admin') {
  const { id, title, text, author, email } = lawData;
