...
const KT_HEADER = `// This file is generated by shared/design-tokens/export-android-tokens.ts.
// Do not edit by hand. Regenerate with: npm run design:export:android
//
...
<!--
  This file is generated by shared/design-tokens/export-android-tokens.ts.
  Do not edit by hand. Regenerate from the repo root with: npm run design:export:android
-->
`;
...
function renderKotlinTypography(
  ...
  // `WorkSans` is a hand-authored FontFamily declared in WorkSans.kt that
  // wraps the bundled `res/font/work_sans_variable.ttf` with weight-aware
  // variation settings. Letter-spacing is converted from CSS em to
  // absolute sp at codegen time.
  lines.push('            fontFamily = WorkSans,');
